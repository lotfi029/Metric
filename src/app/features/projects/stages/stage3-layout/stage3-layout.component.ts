...
@Component({
  selector: 'app-stage3-layout',
  standalone: true,
  imports: [CommonModule],
  templateUrl: '../stage-template.component.html',
  styleUrls: ['../stage.component.css']
})
export class Stage3LayoutComponent implements OnInit {
  projectId: string = '';
  stage = 3;
  stageName = 'Space Planning';
  stageDescription = 'Develop spatial layouts and furniture arrangements';
