...
@Component({
  selector: 'app-stage4-moodboard',
  standalone: true,
  imports: [CommonModule],
  templateUrl: '../stage-template.component.html',
  styleUrls: ['../stage.component.css']
})
export class Stage4MoodboardComponent implements OnInit {
  projectId: string = '';
  stage = 4;
  stageName = 'Moodboard & Design';
  stageDescription = 'Create design concepts, color schemes, and material selections';
