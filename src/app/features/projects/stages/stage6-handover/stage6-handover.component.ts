...
@Component({
  selector: 'app-stage6-handover',
  standalone: true,
  imports: [CommonModule],
  templateUrl: '../stage-template.component.html',
  styleUrls: ['../stage.component.css']
})
export class Stage6HandoverComponent implements OnInit {
  projectId: string = '';
  stage = 6;
  stageName = 'Handover';
  stageDescription = 'Approve design and obtain client sign-off for execution';
