...
@Component({
  selector: 'app-stage5-renders',
  standalone: true,
  imports: [CommonModule],
  templateUrl: '../stage-template.component.html',
  styleUrls: ['../stage.component.css']
})
export class Stage5RendersComponent implements OnInit {
  projectId: string = '';
  stage = 5;
  stageName = '3D Renders';
  stageDescription = 'Generate 3D visualizations and presentation materials';
