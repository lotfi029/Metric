...
@Component({
  selector: 'app-stage7-techprep',
  standalone: true,
  imports: [CommonModule],
  templateUrl: '../stage-template.component.html',
  styleUrls: ['../stage.component.css']
})
export class Stage7TechprepComponent implements OnInit {
  projectId: string = '';
  stage = 7;
  stageName = 'Technical Prep';
  stageDescription = 'Prepare technical specifications and procurement documentation';
