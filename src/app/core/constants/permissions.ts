...
export const ALL_PERMISSIONS: { group: string; key: string; displayName: string }[] = [
  ...
  { group: 'Employees', key: PERMISSIONS.employees.viewDetails, displayName: 'View Employee Details' },
  { group: 'Employees', key: PERMISSIONS.employees.deactivate, displayName: 'Deactivate Employees' },
  { group: 'Employees', key: PERMISSIONS.employees.delete, displayName: 'Delete Employees' },
  ...
  { group: 'Clients', key: PERMISSIONS.clients.delete, displayName: 'Delete Clients' },
  ...
  { group: 'Departments', key: PERMISSIONS.departments.viewUsers, displayName: 'View Dept Members' },
  { group: 'Departments', key: PERMISSIONS.departments.assignToUser, displayName: 'Assign Employee to Dept' },
  { group: 'Departments', key: PERMISSIONS.departments.removeFromUser, displayName: 'Remove from Dept' },
  { group: 'Departments', key: PERMISSIONS.departments.moveUser, displayName: 'Move Employee' },
  { group: 'Departments', key: PERMISSIONS.departments.assignHead, displayName: 'Assign Dept Head' },
  { group: 'Departments', key: PERMISSIONS.departments.deactivate, displayName: 'Deactivate Departments' },
  { group: 'Departments', key: PERMISSIONS.departments.delete, displayName: 'Delete Departments' },
  ...
  { group: 'Roles', key: PERMISSIONS.roles.removeFromUser, displayName: 'Remove Role from User' },
  ...
  { group: 'Permissions', key: PERMISSIONS.permissions.assignToRole, displayName: 'Assign to Role' },
  { group: 'Permissions', key: PERMISSIONS.permissions.removeFromRole, displayName: 'Remove from Role' },
